...
\usepackage{textgreek} % Required for writing greek letters in text mode
\usepackage{todonotes} % Required for marking todoes
...
\newcommand{\webpageurl}{\url{github.com/Hu13er/follandnotes}}
